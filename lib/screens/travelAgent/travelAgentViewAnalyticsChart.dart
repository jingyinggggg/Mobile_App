...
import 'package:assignment_tripmate/screens/travelAgent/travelAgentViewAnalyticsChartDetails.dart';
...
class TravelAgentViewAnalyticsChartScreen extends StatefulWidget {
  ...
  const TravelAgentViewAnalyticsChartScreen({super.key, required this.userId});
  ...
  Future<void> _fetchCarRentalBookingList(int year) async {
    ...
    try {
      ...
      QuerySnapshot carPackagesSnapshot = await carPackagesRef
          .where('agencyID', isEqualTo: widget.userId)
          .get();
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => TravelAgentViewAnalyticsChartDetailScreen(userId: widget.userId,tourID: tourBooking.tourID,year: selectedYear,)
          ),
        );
      },
      child: Container(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => TravelAgentViewAnalyticsChartDetailScreen(userId: widget.userId,carID: carRentalBooking.carRentalID, year: selectedYear,)
          ),
        );
      },
      child: Container(
