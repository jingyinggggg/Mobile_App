...
class LocalBuddyRevenueDetailsScreen extends StatefulWidget {
  final String userId;
  final String withdrawalID;
  final String localBuddyID;

  const LocalBuddyRevenueDetailsScreen({
    super.key,
  ...
  @override
  State<LocalBuddyRevenueDetailsScreen> createState() => _LocalBuddyRevenueDetailsScreenState();
}

class _LocalBuddyRevenueDetailsScreenState extends State<LocalBuddyRevenueDetailsScreen> {
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => LocalBuddyRevenueScreen(userId: widget.userId, localBuddyID: widget.localBuddyID,))
            );
          },
        ),
      ),
